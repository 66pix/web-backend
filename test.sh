...
npm run build && node_modules/.bin/istanbul cover --dir $COVERAGE_DIR node_modules/.bin/_mocha -- --timeout 30000 --recursive --reporter spec typescript/test/configure.js typescript/test/
