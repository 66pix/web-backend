...
describe('Routes authentication logout', function() {
  ...
  it('should return 204 if the jwt token is invalid', function(done) {
    request(app)
  ...
  it('should return 204 if the jwt token is not present in the database', function(done) {
